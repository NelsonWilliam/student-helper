...
wget -O ~/.joplin/Student Helperrt-$version-x86_64.AppImage https://github.com/laurent22/joplin/releases/download/v$version/Student Helperrt-$version-x86_64.AppImage 
# Gives execution privileges
chmod +x ~/.joplin/Student Helperrt-$version-x86_64.AppImage
# Download icon
wget -O ~/.joplin/Icon512.png https://joplin.cozic.net/images/Icon512.png
# Create icon for Gnome
echo -e "[Desktop Entry]\nEncoding=UTF-8\nName=Student Helperrt\nExec=/home/$USER/.joplin/Student Helperrt-$version-x86_64.AppImage\nIcon=/home/$USER/.joplin/Icon512.png\nType=Application\nCategories=Application;" >> ~/.local/share/applications/joplin.desktop
# Informs the user that it has been installed and cleans variables
echo 'Student Helperrt installed in the version' $version
unset version
